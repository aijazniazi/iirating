...
<tbody class="row">	
                              ...
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/KTPB-PR-2019.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
...
<tbody class="row">	
                              ...
                              <ul class="files">
                                            <li> &nbsp; &nbsp; <a  href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/PR-TIIC_2018.pdf"  target="_blank">Press Release</a></li>
                                     </ul>
...
<tbody class="row">
								...
								<td>AlBaraka Bank Lebanon S.A.L.
                                  <ul class="files">
                                            <li> &nbsp; &nbsp; <a target="_blank" href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/PR-ABBL-Apr'2016-Eng.pdf">Press Release</a></li>
                                     </ul>
...
<tbody class="row">           
 			<tr class="data">
								<td >Albaraka Türk Katilim Bankasi A.Ş.
                                  <ul class="files">
                                            <li> &nbsp; &nbsp; <a target="_blank" href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/PR-ATKB-Nov'2018.pdf">Press Release</a></li>
                                     </ul>
...
<tbody class="row">
								...
								<td >Al Baraka Bank Syria
                                  <ul class="files">
                                            ...
                                            <li> &nbsp; &nbsp; <a target="_blank" href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/PR-BBSY-Nov'2018.pdf">Press Release</a></li>
                                     </ul>
...
<tbody class="row">
                             <tr class="data">
                                ...
                                <ul class="files">
                                <li> &nbsp; &nbsp; <a target="_blank" href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/PR-Turkey-2018.pdf" target="_blank">Press Release</a></li>
                                     </ul>
                                </td>
                                                  <td>Turkey</td>
...
<tbody class="row">
								...
								<td >Jordan Islamic Bank
                                  <ul class="files">
                                            <li> &nbsp; &nbsp; <a target="_blank" href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/PR-JIB-Oct'2018.pdf">Press Release</a></li>
                                     </ul>
...
<tbody class="row">
                             <tr class="data">
                                ...
                                <ul class="files">
                                <li> &nbsp; &nbsp; <a href="https://s3-us-west-2.amazonaws.com/iirating/Press+Releases/PR-JIB-SQR-Oct'2018.pdf" target="_blank">Press Release</a></li>
                                     </ul>
                                </td>
                                                  <td>Jordan</td>
                                                   <!-- <td>Shari’a Quality</td>-->
