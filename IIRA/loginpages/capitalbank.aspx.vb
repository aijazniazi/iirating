...
Partial Class loginpages_capitalbank
 ...
 Protected Sub LinkButton2_Click(sender As Object, e As System.EventArgs) Handles LinkButton2.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Fiduciary Rating Report-UCB-Oct'2018.pdf"
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As System.EventArgs) Handles LinkButton1.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Fiduciary Rating Report-UCB-Feb'2017.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
    ...
    Protected Sub LinkButton3_Click(sender As Object, e As System.EventArgs) Handles LinkButton3.Click
        ...
        Else
            ...
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Fiduciary Rating Report-UCB-Mar'2016.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
