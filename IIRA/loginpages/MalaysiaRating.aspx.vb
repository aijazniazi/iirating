...
Partial Class loginpages_MalaysiaRating
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As System.EventArgs) Handles LinkButton1.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Sovereign Report- Malaysia-Dec'2017.pdf"
    ...
    '          Response.Redirect("~/login.aspx")
    '      Else
    '          Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Sovereign Rating Report - Malaysia-Jan'2019.pdf"
    '          Dim fileInfo As New FileInfo(Server.MapPath(URL))
