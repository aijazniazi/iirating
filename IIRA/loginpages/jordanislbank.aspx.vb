...
Partial Class loginpages_jordanislbank
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As System.EventArgs) Handles LinkButton1.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Rating Report-JIB-Nov'2017.pdf"
    ...
    Protected Sub LinkButton3_Click(sender As Object, e As System.EventArgs) Handles LinkButton3.Click
        ...
        Else
            ...
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Rating Report-JIB-Nov'2016.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
    ...
    '            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Rating Report-JIB-Oct'2018.pdf"
    '            Dim fileInfo As New FileInfo(Server.MapPath(URL))
