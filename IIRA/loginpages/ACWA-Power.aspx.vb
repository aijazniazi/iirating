...
Partial Class loginpages_AcWA
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As System.EventArgs) Handles LinkButton1.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/Fiduciary Rating Report-ACWA-Feb'2018.pdf"
    ...
    '        Response.Redirect("~/login.aspx")
    '    Else
    '        Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/PR-ACWA-Aug'2018.pdf"
    '        Dim fileInfo As New FileInfo(Server.MapPath(URL))
