...
Partial Class loginpages_jordanislamicbank
    ...
    Protected Sub LinkButton1_Click(sender As Object, e As System.EventArgs) Handles LinkButton1.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/SQR-JIB-Dec'2016.pdf"
	...
	Protected Sub LinkButton3_Click(sender As Object, e As System.EventArgs) Handles LinkButton3.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/SQR-JIB-Jan'2016.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
...
Protected Sub LinkButton4_Click(sender As Object, e As System.EventArgs) Handles LinkButton4.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/SQR-JIB-Feb'2015.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
...
Protected Sub LinkButton5_Click(sender As Object, e As System.EventArgs) Handles LinkButton5.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/SQR-JIB-Dec'2013.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
...
Protected Sub LinkButton6_Click(sender As Object, e As System.EventArgs) Handles LinkButton6.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/SQR-JIB-Jan2018.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
...
Protected Sub LinkButton7_Click(sender As Object, e As System.EventArgs) Handles LinkButton7.Click
        If Session("username") = "" Or Session("username") = Nothing Then
            Response.Redirect("~/login.aspx")
        Else
            Dim URL As String = "https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/SQR-JIB-Oct'2018.pdf"
            Dim fileInfo As New FileInfo(Server.MapPath(URL))
