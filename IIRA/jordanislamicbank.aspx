<%@ Page Language="VB" AutoEventWireup="false" CodeFile="~/IIRA/loginpages/jordanislbank.aspx.vb" Inherits="loginpages_jordanislbank" %>
				 ...
				 <div class="box box-shadow" style="padding:10px;" >
                                <table>
                                    <tr>
                                     ...
                                     <td> 
                      		 <a href="https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/FS/Jordan Islamic Bank- Financial Information.xlsx"><img src="../images/excel_icon.png" height="30px" style="float:left;margin-left:10px;margin-right:10px;border-right:1px solid black;padding-right:20px;vertical-align:middle;" /></a>
                      </td>
                      <td>
                                    <a href="https://s3-us-west-2.amazonaws.com/iirating/loginpages/Reports/FS/Jordan Islamic Bank- Financial Information.xlsx" class="buttonClass">Financial Statements</a></td>
                      </tr>
                      </table>
